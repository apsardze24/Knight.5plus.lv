...
const CookiePolicyScreen: React.FC<LegalScreenProps> = ({ onBack }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-gray-700/50 backdrop-blur-sm p-6 rounded-xl shadow-lg text-white animate-fade-in">
      <h2 className="text-2xl font-bold mb-4 text-green-400">{t('legal.cookiesTitle')}</h2>
      <p className="text-gray-300 whitespace-pre-line">{t('legal.cookiesContent')}</p>
      <button 
        onClick={onBack}
